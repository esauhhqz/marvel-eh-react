...
const AboutCharComics = () => {
    ...
    useEffect(()=>{
        const fetchData = async() =>{
            const response =  await axios.post('http://localhost:5000/charComicsInfo', {id})
  ...
  return (
      <div>
        ...
        <h1 className='text-[3.75vmin] font-bold p-3 text-center under' >Comics</h1>
        <div  >
            <table className=''>
            <thead>
                <tr>              
...
export default AboutCharComics